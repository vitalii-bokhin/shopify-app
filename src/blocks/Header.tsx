...
export default function Header(props: { appLoading: any; userName: string; avatar: string; }) {
    return props.appLoading ? (
        <div className='Polaris-TopBar_z6tf9'>
            <div className="Polaris-TopBar__ContextControl_3di0f"><div className="pIYWy"><div><img alt="Shopify Editions" src={logo.default} className="CHSY2" /><img alt="Shopify Editions" src={logo2.default} className="m9n8p" /></div></div></div><div className="Polaris-TopBar__Contents_1u1wn"><div className="Polaris-TopBar__SearchField_ek145"><div className="wxQ_9"></div></div><div className="Polaris-TopBar__SecondaryMenu_7y4ay"></div><div className="fTqdT"><div className="WO7Ww"></div><div className="SNQXW"></div></div></div>
        </div>
    ) : (
        <div>
            <div className="Polaris-TopBar_z6tf9"><button type="button" className="Polaris-TopBar__NavigationIcon_1bdcy"
                ...
                <div className="Polaris-TopBar__ContextControl_3di0f">
                    <div className="xtW1C">
                        <div className="Y90id">
                            <img alt="Shopify Editions" src={logo.default} className="HpTKZ xa0qG" />
                            <img alt="Shopify Editions" src={logo2.default} className="BCsv_" />
                        </div>
