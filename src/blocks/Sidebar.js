export default function Sidebar(props) {
    return props.appLoading ? (
        ...
        <div dangerouslySetInnerHTML={{
            __html: `<nav class="Polaris-Navigation_1ajsq">
              <div class="Polaris-Navigation__LogoContainer_szav1 Polaris-Navigation--hasLogoSuffix_1x6t8"><a
                  data-polaris-unstyled="true" class="Polaris-Navigation__LogoLink_eekya" href="/admin" style="width: 100px;"><img
                    alt="Shopify" src="https://cdn.shopify.com/shopifycloud/web/assets/v1/d13f648bd87c8c73.svg"
                    class="Polaris-Navigation__Logo_yj38q" style="width: 100px;"></a><a
                  ...
                  target="_blank" rel="noopener noreferrer" data-polaris-unstyled="true"><span class="bBmk8">Winter ‘23</span></a>
              </div>
              <div
                class="Polaris-Navigation__PrimaryNavigation_1i4zc Polaris-Scrollable_1ed9o Polaris-Scrollable--vertical_uiuuj Polaris-Scrollable--horizontal_17qq4"
                data-polaris-scrollable="true">
                <div>
                  <ul class="Polaris-Navigation__Section_1b1h1">
                    <li class="Polaris-Navigation__ListItem_wxd2m">
                      <div class="Polaris-Navigation__ItemWrapper_1kbav">
                        <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                            class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false" href="/admin">
                            <div class="Polaris-Navigation__Icon_yj27d"><span class="Polaris-Icon_yj27d"><span
                                  class="Polaris-Text--root_yj4ah Polaris-Text--visuallyHidden_yrtt6"></span><svg
                                  viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                  <path
                                    d="M10.555 3.168a1 1 0 0 0-1.11 0l-5.554 3.702a2 2 0 0 0-.891 1.665v6.465a2 2 0 0 0 2 2h2a1 1 0 0 0 1-1v-4h4v4a1 1 0 0 0 1 1h2a2 2 0 0 0 2-2v-6.465a2 2 0 0 0-.89-1.664l-5.555-3.703Z">
                                  </path>
                                </svg></span></div><span class="Polaris-Navigation__Text_yj3uv">Home</span>
                    ...
                    <li class="Polaris-Navigation__ListItem_wxd2m">
                      <div class="Polaris-Navigation__ItemWrapper_1kbav">
                        <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                            class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false" aria-expanded="false"
                            ...
                            <div class="Polaris-Navigation__Badge_2qgie"></div>
                          </a></div>
                      </div>
                    ...
                    <li class="Polaris-Navigation__ListItem_wxd2m">
                      <div class="Polaris-Navigation__ItemWrapper_1kbav">
                        <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                            class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false" href="/admin/customers">
                            <div class="Polaris-Navigation__Icon_yj27d"><span class="Polaris-Icon_yj27d"><span
                                  class="Polaris-Text--root_yj4ah Polaris-Text--visuallyHidden_yrtt6"></span><svg
                                  viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                  <path
                    ...
                    <li class="Polaris-Navigation__ListItem_wxd2m">
                      <div class="Polaris-Navigation__ItemWrapper_1kbav">
                        <div
                          class="Polaris-Navigation__ItemInnerWrapper_1umqf Polaris-Navigation__ItemInnerWrapper--selected_27m8g">
                      ...
                      <div class="Polaris-Navigation__SecondaryNavigation_na5at">
                        <div id="PolarisSecondaryNavigation18" class="Polaris-Collapsible_1dqql" aria-hidden="false"
                          style="max-height: none; overflow: visible;">
                          <ul class="Polaris-Navigation__List_yj3nl">
                            <li class="Polaris-Navigation__ListItem_wxd2m">
                              <div class="Polaris-Navigation__ItemWrapper_1kbav">
                                <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                                    class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false"
                                    href="/admin/reports"><span class="Polaris-Navigation__Text_yj3uv">Reports</span></a></div>
                              </div>
                            </li>
                            <li class="Polaris-Navigation__ListItem_wxd2m">
                              <div class="Polaris-Navigation__ItemWrapper_1kbav">
                                <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                                    class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false"
                                    href="/admin/dashboards/live"><span class="Polaris-Navigation__Text_yj3uv">Live
                                      View</span></a></div>
                              </div>
                            </li>
                          </ul>
                    ...
                    <li class="Polaris-Navigation__ListItem_wxd2m">
                      <div class="Polaris-Navigation__ItemWrapper_1kbav">
                        <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                            class="Polaris-Navigation__Item_yiyol" tabindex="0" aria-disabled="false" href="/admin/discounts">
                            <div class="Polaris-Navigation__Icon_yj27d"><span class="Polaris-Icon_yj27d"><span
                                  class="Polaris-Text--root_yj4ah Polaris-Text--visuallyHidden_yrtt6"></span><svg
                                  viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                  <path fill-rule="evenodd"
                ...
                <div class="tCaSv">
                  <ul class="Polaris-Navigation__Section_1b1h1">
                    <li class="Polaris-Navigation__ListItem_wxd2m">
                      <div class="Polaris-Navigation__ItemWrapper_1kbav">
                        <div class="Polaris-Navigation__ItemInnerWrapper_1umqf"><a data-polaris-unstyled="true"
                            class="Polaris-Navigation__Item_yiyol" tabindex="0" href="/admin/settings">
                            <div class="Polaris-Navigation__Icon_yj27d"><span class="Polaris-Icon_yj27d"><span
                                  class="Polaris-Text--root_yj4ah Polaris-Text--visuallyHidden_yrtt6"></span><svg
                                  viewBox="0 0 20 20" class="Polaris-Icon__Svg_375hu" focusable="false" aria-hidden="true">
                                  <path
